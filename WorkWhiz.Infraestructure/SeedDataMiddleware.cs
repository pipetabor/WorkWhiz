...
namespace WorkWhiz.Infraestructure
{
    public class SeedDataMiddleware
    {
        ...
        public SeedDataMiddleware(RequestDelegate next, ApiContext context)
        {
            _next = next;
            _context = context;
        }
    ...
    /*
    public class SeedMemoryDb
    {
        public async Task SeedAsync(ApiContext context)
        {
            ...
            {
                var bidders = GenerateBidders(20);
                context.Bidders.AddRange(bidders);
            }
